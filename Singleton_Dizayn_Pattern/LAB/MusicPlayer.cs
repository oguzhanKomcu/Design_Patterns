...
namespace Singleton_Dizayn_Pattern.LAB
{
    public  class MusicPlayer
    {
        ...
        //In order to prevent our constructor method used while creating an object from being used outside of our class and producing a new object, we have set it as "Private", but I can call it inside my class and use it.
        private MusicPlayer()
        {
        ...
        public static MusicPlayer Instance()
        {
            ...
            //To check, I created an if block. So if the object is not created, I created it and marked it in its reference. If it is, I get the created object.
            if (_instance == null)
            {
